...
class PegassApp < Sinatra::Base
  ...
  helpers do
    def get_connexion
      ...
      elsif(request.env['HTTP_USERNAME'])
  ...
  options "*" do
    ...
    response.headers["Access-Control-Allow-Headers"] = "X-Requested-With, X-HTTP-Method-Override, Content-Type, Cache-Control, Accept, Authorization, username, password, F5_ST, LastMRH_Session, MRHSession, JSESSIONID, SAML"
